...
/**
 * Guarda la configuraciÃƒÂ³n, el estado de calibraciÃƒÂ³n y las plantillas de ojo del usuario.
 *
 * Esta clase es la persistencia del sistema: aquÃƒÂ­ se guardan las imÃƒÂ¡genes tomadas durante
 * la calibraciÃƒÂ³n para que luego el detector compare la mirada actual contra esas referencias.
 */
public class UserDataManager extends Application {
    ...
    Context mContext;
    // Valores de configuraciÃƒÂ³n y estado del usuario
    ...
    public void setCalibrationState(int calibrationState) {
        Log.d("UserDataManager", "Calibration state set to: " + calibrationState);
        // Estado del proceso de calibraciÃƒÂ³n.
        // Cuando termina, se usa este valor para activar la comparaciÃƒÂ³n con plantillas.
    ...
    /**
     * Guarda la imagen del ojo izquierdo para un punto de calibraciÃƒÂ³n concreto.
     * Ejemplo: mirar arriba, izquierda, derecha, etc.
     */
    public void setLeftCalibrationData(Bitmap leftCalibrationData, int index) {
        if (this.leftCalibrationData == null) {
            this.leftCalibrationData = new Bitmap[calibrationTemplateNum];
        }
    ...
    /**
     * Guarda la imagen del ojo derecho para el mismo punto de calibraciÃƒÂ³n.
     */
    public void setRightCalibrationData(Bitmap rightCalibrationData, int index) {
        if (this.rightCalibrationData == null) {
            this.rightCalibrationData = new Bitmap[calibrationTemplateNum];
        }
